...
define(["Window", "memory", "random", "rss", "imageGallery"], function(Window, memory, random, rss, imageGallery){
    ...
    function rssIcon(){
        ...
        document.getElementById("linkRssIcon").addEventListener("click", createRSSFeed);
        
    };   
    function imageGallerIcon(){
        var appArea = document.getElementById("appArea");
        ...
        document.getElementById("linkImageGalleriIcon").addEventListener("click", createImageGallery);
    ...
    function memoryIcon(){
        ...
        document.getElementById("linkMemoryIcon").addEventListener("click", createMemoryGame);
    ...
    function createMemoryGame(){
         var myMemory = new memory(4,4,++instanceId);
          myMemory.start();
    } ;      
    init();
